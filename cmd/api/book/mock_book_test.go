...
//
//	mockgen.exe -destination mock_book_test.go -package book_test . Repository
//
// Package book_test is a generated GoMock package.
package book_test
...
func (m *MockRepository) CreateBook(arg0 book.Book) (book.Book, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) CreateBook(arg0 any) *gomock.Call {

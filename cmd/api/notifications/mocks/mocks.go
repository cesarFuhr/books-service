...
// Source: github.com/books-service/cmd/api/notifications (interfaces: Doer)
//
// Generated by this command:
//
//	mockgen.exe -destination B:/dev/books/books-service/cmd/api/notifications/mocks/mocks.go -package notifications . Doer
//
